...
// The "Toolbox" (Interface) structure for Haiku
struct os_interface haiku_os_interface = {
    // For now, this is a placeholder.
    // We can add function pointers here for more organized access!
};

// Giving the driver access to the Haiku toolbox
struct os_interface *os_get_interface(void) { return &haiku_os_interface; }